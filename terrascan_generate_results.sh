...
terrascan scan -i k8s -f templates/${chart_folder}_template.yaml -o sarif > results_${iteration}.json
...
echo "Step 3 - Debug"
export iteration="2"
terrascan scan -i k8s -f fixed_templates/${chart_name}_terrascan_fixed_template.yaml --skip-rules AC_K8S_0080 --skip-rules AC_K8S_0069 --skip-rules AC_K8S_0021 --skip-rules AC_K8S_0002 --skip-rules AC_K8S_0068
