...
kubescape scan templates/${chart_folder}_template.yaml --exceptions kubescape_exceptions.json --format json --output results_${iteration}.json > /dev/null 2>&1
...
echo "Step 3 - Debug"
export iteration="2"
kubescape scan fixed_templates/${chart_name}_kubescape_fixed_template.yaml --exceptions kubescape_exceptions.json
